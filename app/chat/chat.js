    ...
    //Gestion des bouton increment
      ...
      function launchSeq( sequence_name ) {
        ...
        seqence.each(function(index, value){
          ...
          $(this).delay(500 * index).fadeIn('', function(){

            if ( $(this).is('.chat_list_item_new') ) {
                $(this).find('.avatar').addClass('avatar_scale');
            }

            $(this).addClass('chat_list_item_slide itemDone').find('.chat_bubble').addClass('chat_bubble_typing').find('span').delay(500).queue( function() {
                $(this).addClass('show');
            });
        ...
        function launchQuest(question_name) {
          ...
          $('.chat_responses.zindex').removeClass('zindex');
          ...
          var btns = $('#' + question_name + ' .chat_response .btn_chat:not(.submit)'),
              index = 0,
          ...
          function clickresponses() {
            ...
            btns.find('input[type=radio], a.submit_input:not(.submit_chat), a.increment').one('click', function(e) {
              ...
              if( btnType === 'radio' ) {
                ...
                $(this).closest('.incr.btn_chat').find('.datas').each( function() {
        ...
        function launchMary() {
          ...
          $('#submit_mary').delay(500).queue( function() {
      ...
      function post_via_ajax() {
          ...
          var chatux_ajax_url = chatux_params.chat_ajax_url,
              $post_name = $('#name').val(),
              $post_mail = $('#email').val(),
