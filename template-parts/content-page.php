...
<section id="post-<?php the_ID(); ?>" class="content-page">
	<?php
      ...
      if( $bkgType2 === 'bkg_uni_part' || $bkgType2 === 'bkg_gradient_part' ) {
      	...
      	$addImg = get_sub_field('add_img_sous_sec_v2_pa');
      	$noAnim = get_sub_field('no_anim_bkg');
      	if( $noAnim == 1 ) {
      		$bkgAnim = 'no_anim';
      	}
    		...
    		if( $addImg ) {
    			if( $secIntro  == '1' ):
	    		echo '<div class="header-bg"></div><header class="header ' . $heightIntro . ' ' . $colorNav . '"><div class="bkg_part ' . $bkgAnim . '" style="' . $bkgColor . ' ' . $posBloc . ' height: ' . $heightBkg . '%; ' . $bkgImg . ' ' . $bkgPos . ' ' . $bkgSize . ' background-repeat: no-repeat; width: ' . $widthBkg . '%" data-rjs="3"></div>';
		    	else :
      		...
      		if( $secIntro  == '1' ):
	    		echo '<div class="header-bg"></div><header class="header ' . $heightIntro . ' ' . $colorNav . '"><div class="bkg_part ' . $bkgAnim . '" style="' . $bkgColor . ' ' . $posBloc . ' height: ' . $heightBkg . '%; width: ' . $widthBkg . '%"></div>';
		    	else :
		    		echo '<div class="section"><div class="bkg_part ' . $bkgAnim . '" style="' . $bkgColor . ' ' . $posBloc . ' height: ' . $heightBkg . '%;" data-width="' . $widthBkg . '%"></div>';
		    	endif;
      	}
      	...
      	if( $addImg ) {
      		if( $secIntro  == '1' ):
	    		echo '<div class="header-bg"></div><header class="header ' . $heightIntro . ' ' . $colorNav . '" style="' . $bkgColor . ' ' . $bkgImg . ' ' . $bkgPos . ' ' . $bkgSize . ' background-repeat: no-repeat;" data-rjs="3">';
		    	else :
      		...
      		if( $secIntro  == '1' ):
	    		echo '<div class="header-bg"></div><header class="header ' . $heightIntro . ' ' . $colorNav . '" style="' . $bkgColor . '">';
		    	else :
		      	...
		      	?>
	      				...
	      				<?php
	      						...
	      						echo '<div class="wrapper">';
	      							echo '<div class="flex-container ' . $nopadding . '">';
					      				echo '<div class="w60 center tiny-w100 small-w75">';
			      							echo '<div class="flex-container">';
			      								echo '<div class="' . $widthCol . ' ' . $blocWhite . ' tiny-w100 small-w100 ' . $centerflex . '">';
					      				...
					      				echo '<div class="w80 center tiny-w100 small-w75">';
			      							echo '<div class="flex-container">';
					      						echo '<div class="w100">';
						      						...
						      						echo '<div class="flex-container">';
						      						echo '<div class="w40 tiny-w100 small-w100">';
						      							echo $contentBloc;
						      						echo '</div>';
						      						echo '<div class="w40 tiny-w100 push small-w100">';
						      							echo $contentBlocBis;
						      						echo '</div>';
						      						echo '</div>';
					      						echo '</div>';
	      					...
	      					elseif( $nbrCol === 'one_col_img') :
	      						...
	      						echo '<div class="wrapper">';
	      							...
	      							echo '<div class="flex-container">';
					      				echo '<div class="w80 center tiny-w100">';
			      							echo '<div class="flex-container">';

					      						echo '<div class="w100 center imgFull">';
					      						$rows = get_sub_field('visuels_right_pa');
	      						...
	      						echo '<div class="grid grid-2-small-1">';
		      						...
		      						echo '</div>';
		      						echo '<div class="one-half paddingR  flex-item-center">';
		      							if( get_sub_field('titre_bloc_pa') ) :
		      								echo '<h2>' . get_sub_field('titre_bloc_pa') . '</h2>';
		      							endif;
		      							echo $contentBlocBis;
	      					...
	      					elseif( $nbrCol === 'two_col_img_right') :
	      						...
	      						echo '<div class="grid-2-small-1">';
	      							echo '<div class="one-half paddingL flex-item-center">';
		      							if( get_sub_field('titre_bloc_pa') ) :
		      								echo '<h2>' . get_sub_field('titre_bloc_pa') . '</h2>';
		      							endif;
	      								echo $contentBloc;
			      	...
			      	if( have_rows('visuels_sfs_pa') ): ?>
			      		<div class="carousel slider_fulls slider_<?php echo $sliderPos1; ?>" data-flickity='{ "freeScroll": true, "pageDots": false, "prevNextButtons": false, "imagesLoaded": true, "cellAlign": "<?php echo $sliderPos1; ?>" }'>
	    					...
	    					<?php while ( have_rows('visuels_sfs_pa') ) : the_row();
		    					...
		    					echo '<img src="' . $urlSfS1 . '" alt="' . $altSfS1 .'" width="' . $widthT1 . '" height="' . $heightT1 . '" data-rjs="3" />';
		    					if( $legende ) {
	    					...
	    					if( $descSlider ) : ?>
	    						...
	    						<div class="wrapper">
	    							<div class="flex-container">
	    								<div class="w60 center tiny-w100">
	    									<div class="w50 tiny-w100 small-w75">
	    										<?php echo $descSlider; ?>
	  										</div>
	    								</div>
	    							</div>
